...
public class Main : MonoBehaviour
{
    ...
    public static int number_of_governments = 1; // ћаксимум - 5
    ...
    void Start()
    {
        ...
        do
        {
            ...
            for (int i = 1; i <= number_of_governments; i++)
            {
                ...
                // —оздание недопустимых точек спавна дл€ других государств (границы с другими государствами)
            ...
            // ѕриведение недопустимых точек спавна дл€ других государств к нормальному виду на карте
            for (int i = 0; i < map.GetLength(0); i++)
                for (int j = 0; j < map.GetLength(1); j++)
